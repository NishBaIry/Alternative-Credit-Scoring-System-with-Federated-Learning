...
export const APP_TYPE = import.meta.env.VITE_APP_TYPE || 'client';
export const BANK_ID = import.meta.env.VITE_BANK_ID || null;
export const BANK_NAME = import.meta.env.VITE_BANK_NAME || null;
